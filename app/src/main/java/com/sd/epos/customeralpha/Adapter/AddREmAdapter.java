 ...
 */
public class AddREmAdapter extends RecyclerView.Adapter<AddREmAdapter.ViewHolder> {
    ...
    public AddREmAdapter(Context context, List<Data> layoutResourceId) {
        super();
